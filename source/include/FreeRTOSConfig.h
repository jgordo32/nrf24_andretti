...
// Define portUSE_TIMER0 to use the Arduino & Timer0 
// Otherwise use Pololu SVP 1284P & Timer3

#if (defined(__AVR_ATmega1284P__) || defined(__AVR_ATmega1284PA__)) // Use Pololu SVP 1284p & Timer3
